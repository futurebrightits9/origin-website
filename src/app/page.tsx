  ...
  return (
    <div className="flex flex-col">
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center text-center text-white">
        <Image src="https://picsum.photos/1920/1080" data-ai-hint="technology education" layout="fill" objectFit="cover" alt="Hero background" className="absolute inset-0 z-0 brightness-50" />
